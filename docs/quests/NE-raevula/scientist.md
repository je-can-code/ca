...
## Location
### Day
Raevula, the Comfy Bear Inn, upstairs in the Comfy Embrace during the day- and later her lab.

### Night
Raevula, the Red Baron Pub, at the bar during the night.

## About
The scientist, introduced as Treis, apparently crashlanded onto this planet while on some sort of space exploration
mission. Her crew all died on landing, while somehow she survived unphased. She is a bossy sort of individual. She will
tell the player and team where to go and what to do for the first few chapters of the story, but later ends up just
accepting her fate and wanting to study the planet she crashlanded on.

In addition to being a scientist, she is also an inventor and creates tools for the player as the main story progresses
and more are needed, such as bombs.

## Quests

### 0) Unlock Quest: `main-007`
While Treis is not the questgiver of this quest, nor really involved in it a whole lot, she is busy hanging outside of
...
#### After effects of "Structural Integrity"
...
#### After effects of "A Technical Suite"
While there is no variance in the tools being built, by building these tools the player will have access to Treis'
"invent" functionality- another aspect of JAFTING. Additionally, all future quests for Treis will be taken from the lab
where she now apparently lives instead of the Comfy Bear Inn.