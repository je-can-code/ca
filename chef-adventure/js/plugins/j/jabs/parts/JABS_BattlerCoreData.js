 ...
 * @target MZ
 * @plugindesc 
 * [v3.0 JABS] Core data structure of a JABS_Battler.
 * @author JE
 ...
 * ============================================================================
 * A component of JABS.
 * This class represents the common data that all battlers share, such as
 * sight range, the character the jabs_battler belongs to, the actual battler
 * (actor or enemy) that this jabs_battler is bound to, etc.
 * ============================================================================
 */
